...
import { registerSalesMan as registerUserApi } from "../services/user";
...
function RegisterSalesman() {
  ...
  const [userRoles, setUsersRoles] = useState("SALESPERSON");
  ...
  return (
    <div>
      <h1 style={{ textAlign: "center", margin: 10 }}>Register salesman</h1>
