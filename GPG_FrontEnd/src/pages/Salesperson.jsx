...
const Salesperson = () => {
  ...
  const handleStatusChange = (bookingId) => {
    ...
    axios
      .put(url, { status: "SUCCESSFUL" })
      .then((response) => {
        toast.success(
          "You Accept The Request ..... Having BookingId = " + bookingId
        );
        fetchCarBookings();
      })
      .catch((error) => {
  ...
  const deleteInsurance = (id) => {
    const url = createUrl(`/insurance/${id}`);
    axios.delete(url).then((res) => {
      log(res);
      fetchInsurances(); // Refresh the finances list after deletion
      toast.error("Insurance Deleted SucessFully!! id = " + id);
      log(res.data);
  ...
  const addInsurances = () => {
    navigate("/addInsurances");
  };
  const addFinancer = () => {
    navigate("/addFinancer");
  };
    ...
    <div className="container mt-5">
      ...
      <div className="card mb-3">
        <div className="card-body">
                ...
                <tr key={finance.financeId}>
                  ...
                  <td>
                    <button
                      ...
                      onClick={() => {
                        deleteFinance(finance.financeId);
                      }}
                    >
                      Delete
                    </button>
          ...
          <div className="total">
            <button
              className="btn btn-outline-secondary ntn-sm"
              onClick={addFinancer}
            >
              Add-Financer
            </button>
                ...
                <tr key={insurance.id}>
                  ...
                  <td>
                    <button
                      className="btn btn-outline-danger btn-sm"
                      onClick={() => {
                        deleteInsurance(insurance.insuranceId);
                      }}
                    >
                      Delete
                    </button>
